...
namespace ReminderApp.InfrastructureLayer.Repository
{
    public class ReminderRepository : IReminderRepository
    {
        ...
        {
            _context = new ReminderAppDbContext();
        }
        public ReminderRepository(ReminderAppDbContext context)
        {
            _context = context;
        }
        public async Task AddReminderAsync(Reminder reminder)
        {
            using (var connection = _context.GetConnection())
            {
                ...
                var query = @"INSERT INTO Reminder (Title, Description, ReminderTime, StatusId,FormId)
                              VALUES (@Title, @Description, @ReminderTime, @StatusId,@FormId)";
                ...
                using (var command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@FormId", reminder.FormId);
        ...
        public async Task<List<Reminder>> GetAllReminderAsync(string statusName, int formId)
        {
            ...
            var query = @"
            SELECT r.Id, r.Title, r.Description, r.ReminderTime, r.StatusId, s.Name AS StatusName, r.FormId
            FROM Reminder r
            INNER JOIN Status s ON r.StatusId = s.Id
            WHERE s.Name = @StatusName AND r.FormId = @FormId;";
